...
$1-`r model$results$Accuracy[model$results$mtry==model$finalModel$mtry]` = `r 1-model$results$Accuracy[model$results$mtry==model$finalModel$mtry]`$. The out-of-sample error should be close to this value (usually
...
The out-of-sample error is $1-`r Q$overall["Accuracy"]`=`r 1-Q$overall["Accuracy"]`$, therefore
